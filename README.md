...
- **Many frames from one pick** — `today`, `yesterday`, `24h`, `7d`, `30d`, `month`, `year`. Toggle each on or off; the [Frames](#frames) table below notes which are calendar-aligned vs rolling.
